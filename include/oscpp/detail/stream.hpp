...
public:
  BasicWriteStream() : Stream() {}

  BasicWriteStream(void *data, size_t size) : Stream(data, size) {}

  BasicWriteStream(const BasicWriteStream &stream) : Stream(stream) {}
...
public:
  ...
  BasicReadStream(const BasicReadStream &stream) : Stream(stream) {}
